...
function post_logo_callback()
{
    ...
    $postid = $_POST['postid'];
    $postLogo = new PostLogo();
    $fileid = $postLogo->getImageId($filename);
    $postLogo->addPostLogo($fileid, $postid);
    echo "success";
 ...
 * @return void
 */
function the_post_logo() {
    $postlogo = new PostLogo();
    print wp_get_attachment_image($postlogo->getPostLogo(get_the_ID()));
}
